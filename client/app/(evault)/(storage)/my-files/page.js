            ...
            <div className="mt-8 mx-6 relative">
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-7">
                        <button className="w-10 h-10 rounded-3xl hover:bg-hover flex justify-center items-center">
                ...
                <div className="absolute right-1 -bottom-10 gap-3 flex items-center justify-center text-[#3E3E3E]">
                    <button className="w-8 h-8 rounded-3xl hover:bg-hover flex justify-center items-center">
                        <FiArrowDown className="w-5 h-5" />
                    </button>
                    <div className="relative">
                        <button className="flex justify-center items-center px-4 py-1.5 gap-2 rounded-2xl hover:bg-hover">
